...
resource "nsxt_edge_transport_node" "edge_nodes" {
  ...
  standard_host_switch {
    ...
    ip_assignment {
      ...
      static_ip_pool   = data.nsxt_policy_realization_info.ip_pool[each.value.fault_domain].realized_id
    }

    transport_zone_endpoint {
      transport_zone = data.nsxt_policy_transport_zone.tz_overlay.realized_id
    }
    transport_zone_endpoint {
