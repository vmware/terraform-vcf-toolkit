# --------------------------------------------------------------- #
# VCF Bring Up - Management Domain / SDDC Instance
# - Assumes a VCF Cloud Builder Appliance is available
# - Configures available hosts for a Management Cluster
# - Deploys SDDC Management Appliance
...
variable "license_keys" {
  description = "License Keys for the VCF instance"
  type = object({
    esxi    = string
    vsan    = string
    vcenter = string
